    ...
    <div class="card-body">
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="task_name" class="form-control" value="<?= sanitize($task['task_name']) ?>" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Description</label>
                <textarea name="description" class="form-control" rows="3"><?= sanitize($task['description']) ?></textarea>
            </div>
            <div class="mb-3">
